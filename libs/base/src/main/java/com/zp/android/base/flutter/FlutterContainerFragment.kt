...
class FlutterContainerFragment : FlutterFragment(), ISupportFragment {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): FlutterView? {
        ...
        flutterView = super.onCreateView(inflater, container, savedInstanceState)
        flutterView?.run {

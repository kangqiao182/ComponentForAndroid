...
object ApiUtils {
    ...
    fun getSP(): SharedPreferences = PreferenceManager.getDefaultSharedPreferences(getContext())

    fun getConfig(key: String, default: String = "") = getSP().getString(key, default)

    fun setConfig(key: String, value: String) = getSP().edit().putString(key, value).apply()
    ...
    fun createUrlFromParams(url: String, params: Map<String, List<String>>?, /*replaceParam: Map<String, String>? = null,*/ vararg excludes: String): String {
        try {
